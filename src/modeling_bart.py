...
class BartModel(PretrainedBartModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # todo: change to the original deoder
...
class BartForConditionalGeneration(PretrainedBartModel):
    ...
    # @replace_return_docstrings(output_type=Seq2SeqLMOutput, config_class=_CONFIG_FOR_DOC) look source doc
    @add_start_docstrings_to_callable(BART_INPUTS_DOCSTRING)
    ...
    def prepare_inputs_for_generation(self, decoder_input_ids, past, attention_mask, encoder_answer_relevance_atten, use_cache, **kwargs):
        ...
        # todo: change for transformers 3.2.0
        # encoder_outputs, decoder_past_key_values = (kwargs['encoder_outputs'], None)
        return {
    ...
    def _force_token_ids_generation(self, scores, token_ids) -> None: # token_id 2 ids 3.20-02
